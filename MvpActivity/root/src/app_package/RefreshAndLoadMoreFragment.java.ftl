...
public class ${fragmentClass} extends BaseRefreshAndLoadMoreFragment<ApiService, CacheService, ${mvpName}Presenter, Object> implements ${mvpName}Contract.I${mvpName}View {
