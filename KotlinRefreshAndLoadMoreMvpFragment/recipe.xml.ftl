...
<recipe>
    ...
    <instantiate from="root/src/app_package/RefreshAndLoadMoreFragment.kt.ftl"
    ...
    <open file="${projectOut}/src/main/java/${slashedPackageName(packageName)}/ui/activity/${mvpName}Fragment.kt" />
</recipe>
